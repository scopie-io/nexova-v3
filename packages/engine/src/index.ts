...
export { detectInput, classifyUrl, expandShortLinks, appDeepLinkToWeb, platformLabel, regionFromShortHost, CURRENCY_BY_REGION, SHOPEE_SHORT_HOST } from "./ingest/detect.js";
...
export { shopeeScraperProvider, makeShopeeScraperProvider, mapShopeeRow, interpretJob, SHOPEE_SCRAPER_COUNTRIES } from "./ingest/providers/shopee-scraper-api.js";
